...
<%--<body>--%>
    <%--<h1>添加学员</h1>--%>
    <%--<form:form action="/info/addStu" method="post" commandName="user" role="form">--%>
        <%--<div>--%>
            <%--<label>姓名:</label>--%>
        ...
        <%--<div>--%>
            <%--<label>宣言:</label>--%>
            <%--<input type="text" placeholder="请输入入学宣言"/>--%>
        <%--</div>--%>
        <%--<div>--%>
            <%--<label>毕业学校:</label>--%>
        ...
        <%--<div>--%>
            <%--<label>推荐人:</label>--%>
            <%--<input type="text" placeholder="请填写推荐人"/>--%>
        <%--</div>--%>
        <%--<div>--%>
...
<div class="container">
    <h1>添加学员</h1>
    <hr/>
    <form:form action="/info/addStu" method="post" commandName="student" role="form">
